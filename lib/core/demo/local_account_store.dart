  ...
  Future<void> ensureSeeded() async {
    ...
    final seeded = [
      LocalAccount(
        ...
        passwordHash: hashPassword('manniboh@gmail.com', 'Password123'),
        role: 'ADMIN',
      ),
      LocalAccount(
        userId: 2,
        ...
        passwordHash: hashPassword('staff@demo.com', 'DemoPass123'),
        role: 'STAFF',
      ),
      LocalAccount(
        userId: 3,
        ...
        passwordHash: hashPassword('patient@demo.com', 'DemoPass123'),
        role: 'PATIENT',
      ),
    ];
